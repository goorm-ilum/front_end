    ...
    <section className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-3">
          ...
          <button onClick={toggleLike} className={`p-2 rounded-md border transition-colors ${isLiked ? 'bg-red-500 text-white border-red-500' : 'bg-white text-gray-600 border-gray-300 hover:bg-red-50'}`}>
            {isLiked ? (
