...
const AdminProfilePage = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const res = await fetch('/api/adminmember/me', {
          method: 'GET',
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-8">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 mt-4">관리자 계정 정보를 수정하고 관리하세요</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <button 
            onClick={() => navigate(-1)} 
            className="group inline-flex items-center px-6 py-3 text-gray-600 hover:text-gray-800 bg-white/60 backdrop-blur-sm rounded-xl border border-white/30 hover:bg-white/80 transition-all duration-300 hover:shadow-lg"
          >
